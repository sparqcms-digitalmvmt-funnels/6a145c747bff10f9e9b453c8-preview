...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const endpoint =
    ...
    `&with=order_offers,customer_address_billing,customer_address_shipping,customer,transactions,cart&pageId=UP2PMWymHcBdqUDqMJ3QTq5nwE-tAD-U-j6Q1G_7rlFTmwUg_v-R3l1RRqVXhloi`
